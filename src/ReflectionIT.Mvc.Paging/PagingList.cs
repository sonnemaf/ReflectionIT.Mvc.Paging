...
/// including the items for that page and paging metadata.</returns>
    ...
    /// <returns>A PagingList<T> containing the items for the specified page, along with paging metadata such as the current page
    ...
    /// <returns>A PagingList<T> containing the items for the specified page, along with paging and sorting metadata.</returns>
    ...
    /// <summary>
    /// Creates a new PagingList<T> instance representing a single page of data from an ordered query, using the
